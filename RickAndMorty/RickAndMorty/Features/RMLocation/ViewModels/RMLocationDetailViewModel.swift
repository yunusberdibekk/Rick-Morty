...
final class RMLocationDetailViewModel {
    ...
    private func createCellViewModels() {
        ...
        if let date = RMCharacterInformationCollectionViewCellViewModel.dateFormatter.date(from: location.created) {
            createdString = RMCharacterInformationCollectionViewCellViewModel.shortDateFormatter.string(from: date)
        }
